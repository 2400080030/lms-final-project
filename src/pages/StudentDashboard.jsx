...
const StudentDashboard = () => {
        ...
        return (
          <div className="p-6">
            ...
            <ul className="space-y-3">
              <li className="bg-gray-100 p-4 rounded-lg shadow">Front end</li>
              <li className="bg-gray-100 p-4 rounded-lg shadow">Data Science</li>
              <li className="bg-gray-100 p-4 rounded-lg shadow">Database managment system</li>
            </ul>
          </div>
        );
      case "assignments":
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-500 to-pink-400 text-white">
      ...
      <div className="bg-Black text-gray-800 mx-10 mt-8 p-6 rounded-2xl shadow-lg">
        {renderContent()}
      </div>
    </div>
  );
